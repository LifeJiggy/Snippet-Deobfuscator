(globalThis.webpackChunk_github_ui_github_ui = globalThis.webpackChunk_github_ui_github_ui || []).push([["react-lib"], {
    21728: (e, t, n) => {
        "use strict";
        var r, a, l = Object.create, o = Object.defineProperty, u = Object.getOwnPropertyDescriptor, i = Object.getOwnPropertyNames, s = Object.getPrototypeOf, c = Object.prototype.hasOwnProperty, f = (e, t, n, r) => {
            if (t && "object" == typeof t || "function" == typeof t)
                for (let a of i(t))
                    c.call(e, a) || a === n || o(e, a, {
                        get: () => t[a],
        ...
        ( (e, t) => {
            ...
            $structuralCheck: () => F,
            c: () => b,
            clearRenderCounterRegistry: () => P,
            renderCounterRegistry: () => T,
            useRenderCounter: () => R
        }),
        e.exports = f(o({}, "__esModule", {
            value: !0
        }), d);
        var p = ( (e, t, n) => (n = null != e ? l(s(e)) : {},
        f(!t && e && e.__esModule ? n : o(n, "default", {
            value: e,
            enumerable: !0
        }), e)))(n(96540))
          , {useRef: h, useEffect: m, isValidElement: g} = p
          , y = null != (r = p.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE) ? r : p.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
          , v = Symbol.for("react.memo_cache_sentinel")
          , b = "function" == typeof (null == (a = p.__COMPILER_RUNTIME) ? void 0 : a.c) ? p.__COMPILER_RUNTIME.c : function(e) {
            return p.useMemo( () => {
                let t = Array(e);
                for (let n = 0; n < e; n++)
                    t[n] = v;
        ...
        var w = null;
        function S(e) {
            return y.ReactCurrentDispatcher.current = e,
            y.ReactCurrentDispatcher.current
        }
        k.useMemoCache = e => {
            if (null != w)
        ...
        var x = [];
        function E(e) {
            let t = y.ReactCurrentDispatcher.current;
            if (0 === e) {
                if (x.push(t),
                1 === x.length && (w = t),
                t === k)
        ...
        function R(e) {
            ...
            m( () => {
                if (null == t.current) {
                    ...
                    null == (n = T.get(e)) && (n = new Set,
                    T.set(e, n)),
                    n.add(r),
                    t.current = r
                }
                return () => {
                    null !== t.current && function(e, t) {
                        let n = T.get(e);
                        null != n && n.delete(t)
                    }(e, t.current)
                }
                    ...
                    if (t !== n)
                        if (typeof t != typeof n)
                            ...
                            if (null === t && null !== n)
                                ...
                                o(`type ${typeof t}`, "null", r, a);
                            else if (t instanceof Map)
                                if (n instanceof Map)
                                    if (t.size !== n.size)
                                        o(`Map instance with size ${t.size}`, `Map instance with size ${n.size}`, r, a);
                                    else
                                        for (let[l,u] of t)
                                            n.has(l) ? e(u, n.get(l), `${r}.get(${l})`, a + 1) : o(`Map instance with key ${l}`, `Map instance without key ${l}`, r, a);
                                else
                                    o("Map instance", "other value", r, a);
                            else if (n instanceof Map)
                                o("other value", "Map instance", r, a);
                            else if (t instanceof Set)
                                if (n instanceof Set)
                                    if (t.size !== n.size)
                                        o(`Set instance with size ${t.size}`, `Set instance with size ${n.size}`, r, a);
                                    else
                                        for (let e of n)
                                            t.has(e) || o(`Set instance without element ${e}`, `Set instance with element ${e}`, r, a);
                                else
                                    o("Set instance", "other value", r, a);
                            else if (n instanceof Set)
                                o("other value", "Set instance", r, a);
                            else if (l || u)
                                if (l !== u)
                                    o(`type ${l ? "array" : "object"}`, `type ${u ? "array" : "object"}`, r, a);
                                else if (t.length !== n.length)
                                    o(`array with length ${t.length}`, `array with length ${n.length}`, r, a);
                                else
                                    for (let l = 0; l < t.length; l++)
                                        e(t[l], n[l], `${r}[${l}]`, a + 1);
                            else if (g(t) || g(n))
                                g(t) !== g(n) ? o(`type ${g(t) ? "React element" : "object"}`, `type ${g(n) ? "React element" : "object"}`, r, a) : t.type !== n.type ? o(`React element of type ${t.type}`, `React element of type ${n.type}`, r, a) : e(t.props, n.props, `[props of ${r}]`, a + 1);
                            else {
                                for (let e in n)
                                    e in t || o(`object without key ${e}`, `object with key ${e}`, r, a);
                                for (let l in t)
                                    l in n ? e(t[l], n[l], `${r}.${l}`, a + 1) : o(`object with key ${l}`, `object without key ${l}`, r, a)
                            }
                        } else {
    ...
    17633: (e, t, n) => {
        ...
        function ea(e, t, n, r) {
            ...
            "function" == typeof (o = t.getDerivedStateFromProps) && (e.state = a = null == (o = o(n, a)) ? a : L({}, a, o)),
...
`),
                                ...
                                case "input":
                                    ...
                                    null;
                                case "menuitem":
                                    for (var b in e.push(R("menuitem")),
                                    n)
...
`),
                            ...
                            case A:
                                e: {
                                    ...
                                    try {
                                        if (eH(t, n, u),
                                        t.responseState.generateStaticMarkup || h.lastPushedText && h.textEmbedded && h.chunks.push("\x3c!-- --\x3e"),
                                        h.status = 1,
                                        eq(d, h),
                                        0 === d.pendingTasks)
                                            break e
                ...
                if ((o = null === n || "object" != typeof n ? null : "function" == typeof (o = G && n[G] || n["@@iterator"]) ? o : null) && (o = o.call(n))) {
                    if (!(n = o.next()).done) {
                        ...
                        do
                            u.push(n.value),
                            n = o.next();
                        while (!n.done)eA(e, t, u)
                    }
                    return
                }
                throw Error(a(31, "[object Object]" === (e = Object.prototype.toString.call(n)) ? "object with keys {" + Object.keys(n).join(", ") + "}" : e))
            }
            "string" == typeof n ? (o = t.blockedSegment).lastPushedText = M(t.blockedSegment.chunks, n, e.responseState, o.lastPushedText) : "number" == typeof n && ((o = t.blockedSegment).lastPushedText = M(t.blockedSegment.chunks, "" + n, e.responseState, o.lastPushedText))
        }
        function eA(e, t, n) {
        ...
        function eQ(e, t, n) {
            if (null === t) {
                ...
                e.pendingRootTasks--,
                0 === e.pendingRootTasks && (e.onShellError = eL,
                (t = e.onShellReady)())
            } else
                t.pendingTasks--,
                ...
                try {
                    ...
                    for (a = 0; a < l.length; a++) {
                        ...
                        if (0 === u.status) {
                            ...
                            try {
                                ej(e, o, o.node),
                                e.responseState.generateStaticMarkup || u.lastPushedText && u.textEmbedded && u.chunks.push("\x3c!-- --\x3e"),
                                o.abortSet.delete(o),
                                u.status = 1,
...
`)
        ...
        var ek = d('<div hidden id="')
          ...
          , eU = d('">')
          , eB = d("</colgroup></table>")
          , eV = d('function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("')
          , ej = d('$RS("')
          , eA = d('","')
          , eH = d('")<\/script>')
        ...
        function tg(e, t, n, r) {
            ...
            "function" == typeof (o = t.getDerivedStateFromProps) && (e.state = a = null == (o = o(n, a)) ? a : e2({}, a, o)),
            "function" != typeof t.getDerivedStateFromProps && "function" != typeof e.getSnapshotBeforeUpdate && ("function" == typeof e.UNSAFE_componentWillMount || "function" == typeof e.componentWillMount))
                if (t = e.state,
                "function" == typeof e.componentWillMount && e.componentWillMount(),
                "function" == typeof e.UNSAFE_componentWillMount && e.UNSAFE_componentWillMount(),
        ...
        t.renderToReadableStream = function(e, t) {
            return new Promise(function(n, r) {
                ...
                o = function(e, t, n, r, a) {
                    ...
                    var l = [];
                    if (void 0 !== n && l.push(t, f(("" + n).replace(I, O)), F),
                    void 0 !== r)
                ...
                u = D("http://www.w3.org/2000/svg" === (a = t ? t.namespaceURI : void 0) ? 2 : 3 * ("http://www.w3.org/1998/Math/MathML" === a), null),
...
` + a[o].replace(" at new ", " at ");
        ...
        function eA(e, t, n, r, a, l, o, u, i) {
            e$ = !1,
            eU = null,
            eD.apply(ej, arguments)
        }
        function eH(e) {
            var t = e
              , n = e;
        ...
        function tu(e, t, n) {
            e.pendingLanes |= t,
            0x20000000 !== t && (e.suspendedLanes = 0,
            e.pingedLanes = 0),
            ...
            if (tL) {
                ...
                4 & t && -1 < tE.indexOf(e)) {
                    for (; null !== a; ) {
                        var l = rI(a);
                        if (null !== l && tf(l),
                        null === (l = tU(e, t, n, r)) && ro(e, t, r, t$, n),
                        l === a)
                            break;
                        a = l
                    }
        ...
        function tH() {
            if (tA)
                return tA;
            var e, t, n = tj, r = n.length, a = "value"in tV ? tV.value : tV.textContent, l = a.length;
            for (e = 0; e < r && n[e] === a[e]; e++)
                ;
            var o = r - e;
            for (t = 1; t <= o && n[r - t] === a[l - t]; t++)
                ;
            return tA = a.slice(e, 1 < t ? 1 - t : void 0)
        }
        function tW(e) {
            var t = e.keyCode;
        ...
        function nR() {
            nw && (nw.detachEvent("onpropertychange", nN),
            nS = nw = null)
        }
        function nN(e) {
        ...
        function nF(e, t, n) {
            ...
            nw = t,
            nS = n,
            nw.attachEvent("onpropertychange", nN)) : "focusout" === e && nR()
        }
        function nz(e) {
        ...
        var nV = g && "documentMode"in document && 11 >= document.documentMode
          , nj = null
          , nA = null
          , nH = null
          , nW = !1;
        function nq(e, t, n) {
            ...
            nW || null == nj || nj !== G(r) || (r = "selectionStart"in (r = nj) && nB(r) ? {
            ...
            nH && nO(nH, r) || (nH = r,
            0 < (r = ri(nA, "onSelect")).length && (t = new tJ("onSelect","select",null,t,n),
            e.push({
                event: t,
                listeners: r
            }),
        ...
        function ro(e, t, n, r, a) {
            ...
            eM(function() {
                ...
                e: {
                    ...
                    if (void 0 !== u) {
                        ...
                        for (var p, h = r; null !== h; ) {
                            ...
                            null !== d && null != (m = eL(h, d)) && c.push(ru(h, m, p))),
                            f)
                                break;
                            h = h.return
                        }
                ...
                if (0 == (7 & t)) {
                    ...
                    !(u && n !== eS && (s = n.relatedTarget || n.fromElement) && (rL(s) || s[rN]))) && (i || u) && (u = a.window === a ? a : (u = a.ownerDocument) ? u.defaultView || u.parentWindow : window,
                    i ? (s = n.relatedTarget || n.toElement,
                    i = r,
                    null !== (s = s ? rL(s) : null) && (f = eH(s),
                    ...
                    i !== s)) {
                        ...
                        u.relatedTarget = p,
                        m = null,
                        rL(a) === r && ((c = new c(d,h + "enter",s,n,a)).target = p,
                        c.relatedTarget = f,
                        m = c),
                        f = m,
                        i && s)
                    ...
                    e) {
                    case "focusin":
                        (nb(v) || "true" === v.contentEditable) && (nj = v,
                        nA = r,
                        nH = null);
                        break;
                    case "focusout":
                    ...
                    b && (np && "ko" !== n.locale && (ny || "onCompositionStart" !== b ? "onCompositionEnd" === b && ny && (g = tH()) : (tj = "value"in (tV = a) ? tV.value : tV.textContent,
                    ny = !0)),
        ...
        function ri(e, t) {
            for (var n = t + "Capture", r = []; null !== e; ) {
                var a = e
                  , l = a.stateNode;
                5 === a.tag && null !== l && (a = l,
                null != (l = eL(e, n)) && r.unshift(ru(e, l, a)),
                null != (l = eL(e, t)) && r.push(ru(e, l, a))),
                e = e.return
            }
            return r
        }
        ...
        function rc(e, t, n, r, a) {
            for (var l = t._reactName, o = []; null !== n && n !== r; ) {
                ...
                if (null !== i && i === r)
                    break;
                5 === u.tag && null !== s && (u = s,
                a ? null != (i = eL(n, l)) && o.unshift(ru(n, i, u)) : a || null != (i = eL(n, l)) && o.push(ru(n, i, u))),
                n = n.return
            }
            0 !== o.length && e.push({
                event: t,
...
`).replace(rd, "")
        ...
        var rT = Math.random().toString(36).slice(2)
          , rP = "__reactFiber$" + rT
          , rR = "__reactProps$" + rT
          , rN = "__reactContainer$" + rT
          , rF = "__reactEvents$" + rT
          , rz = "__reactListeners$" + rT
          , rM = "__reactHandles$" + rT;
        function rL(e) {
            var t = e[rP];
            if (t)
                return t;
        ...
        function rJ(e, t, n) {
            ...
            if (!r)
                throw Error(f(169));
            n ? (r.__reactInternalMemoizedMergedChildContext = e = rG(e, t, rq),
            rV(rW),
            rV(rH),
            rj(rH, e)) : rV(rW),
            rj(rW, n)
        ...
        function aC(e) {
            ...
            function i(e, t, n, r) {
                var l = n.type;
                return l === R ? c(e, t, n.props.children, r, n.key) : (null !== t && (t.elementType === l || "object" == typeof l && null !== l && l.$$typeof === $ && aE(l) === t.type) ? (r = a(t, n.props)).ref = aS(e, t, n) : (r = uK(n.type, n.key, n.props, null, e.mode, r)).ref = aS(e, t, n),
                r.return = e,
                r)
            }
            function s(e, t, n, r) {
            ...
            return function u(i, s, c, m) {
                if ("object" == typeof c && null !== c && c.type === R && null === c.key && (c = c.props.children),
                        ...
                        e: {
                            for (var g = c.key, y = s; null !== y; ) {
                                if (y.key === g) {
                                    ...
                                    } else if (y.elementType === g || "object" == typeof g && null !== g && g.$$typeof === $ && aE(g) === y.type) {
                                        n(i, y.sibling),
                            ...
                            c.type === R ? ((s = uY(c.props.children, i.mode, m, c.key)).return = i,
        ...
        function l$(e, t) {
            ...
            t = void 0 === t ? null : t;
            var r = n.memoizedState;
            return null !== r && null !== t && lc(t, r[1]) ? r[0] : (n.memoizedState = [e = e(), t],
            e)
        }
        function lU(e, t, n) {
        ...
        var lQ = {
          ...
          , lK = {
            ...
            useImperativeHandle: function(e, t, n) {
                return n = null != n ? n.concat([e]) : null,
                lP(4194308, 4, lL.bind(null, t, e), n)
            },
            ...
            useMemo: function(e, t) {
                ...
                lp().memoizedState = [e = e(), t],
                e
            },
            useReducer: function(e, t, n) {
                var r = lp();
                return r.memoizedState = r.baseState = t = void 0 !== n ? n(t) : t,
                r.queue = e = {
                    pending: null,
                    interleaved: null,
                    lanes: 0,
        ...
        function l1(e, t, n) {
            var r = !1
              , a = rA
              , l = t.contextType;
            return "object" == typeof l && null !== l ? l = aO(l) : (a = rK(t) ? rq : rH.current,
            l = (r = null != (r = t.contextTypes)) ? rQ(e, a) : rA),
            t = new t(n,l),
        ...
        function l3(e, t, n, r) {
            ...
            aj(e);
            var l = t.contextType;
            "object" == typeof l && null !== l ? a.context = aO(l) : a.context = rQ(e, l = rK(t) ? rq : rH.current),
            a.state = e.memoizedState,
...
` + e.stack
        ...
        function od(e, t, n, r, a) {
            ...
            null === t.stateNode)
                ...
                var i = o.context
                  , s = n.contextType;
                s = "object" == typeof s && null !== s ? aO(s) : rQ(t, s = rK(n) ? rq : rH.current);
                ...
                aK(t, r, o, a),
                i = t.memoizedState,
                u !== r || d !== i || rW.current || aV ? ("function" == typeof c && (lZ(t, n, c, r),
                i = t.memoizedState),
                (u = aV || l0(t, n, u, r, d, i, s)) ? (f || "function" != typeof o.UNSAFE_componentWillMount && "function" != typeof o.componentWillMount || ("function" == typeof o.componentWillMount && o.componentWillMount(),
                ...
                f = t.pendingProps,
                d = o.context,
                i = "object" == typeof (i = n.contextType) && null !== i ? aO(i) : rQ(t, i = rK(n) ? rq : rH.current);
                ...
                u !== f || d !== h || rW.current || aV ? ("function" == typeof p && (lZ(t, n, p, r),
                h = t.memoizedState),
                (s = aV || l0(t, n, s, r, d, h, i) || !1) ? (c || "function" != typeof o.UNSAFE_componentWillUpdate && "function" != typeof o.componentWillUpdate || ("function" == typeof o.componentWillUpdate && o.componentWillUpdate(r, h, i),
        ...
        function ov(e, t, n) {
            ...
            null === e)
                return (am(t),
                null !== (e = t.memoizedState) && null !== (e = e.dehydrated)) ? (0 == (1 & t.mode) ? t.lanes = 1 : "$!" === e.data ? t.lanes = 8 : t.lanes = 0x40000000,
                null) : (u = a.children,
                e = a.fallback,
                o ? (a = t.mode,
                o = t.child,
            ...
            if (null !== (l = e.memoizedState) && null !== (r = l.dehydrated)) {
                ...
                if (c)
                    ...
                    ok(i, s, m, d = l6(Error(f(422))))) : null !== s.memoizedState ? (s.child = i.child,
                    s.flags |= 128,
                    null) : (h = d.fallback,
                    p = s.mode,
                    d = uX({
                    ...
                    d.sibling = h,
                    s.child = d,
                    0 != (1 & s.mode) && a_(s, i.child, null, m),
                    s.child.memoizedState = oy(m),
                    s.memoizedState = og,
                    h);
                if (0 == (1 & s.mode))
                    return ok(i, s, m, null);
                if ("$!" === p.data) {
                    if (d = p.nextSibling && p.nextSibling.dataset)
                        var g = d.dgst;
                    return d = g,
                    ok(i, s, m, d = l6(h = Error(f(419)), d, void 0))
                }
                if (g = 0 != (m & i.childLanes),
                oa || g) {
                    if (null !== (d = o2)) {
                        switch (m & -m) {
                        case 4:
                        ...
                        0 !== (p = 0 != (p & (d.suspendedLanes | m)) ? 0 : p) && p !== h.retryLane && (h.retryLane = p,
                        aB(i, p),
                        ub(d, i, p, -1))
                    }
                    return uz(),
                    ok(i, s, m, d = l6(Error(f(421))))
                }
                return "$?" === p.data ? (s.flags |= 128,
                s.child = i.child,
                s = uj.bind(null, i),
                p._reactRetry = s,
                null) : (i = h.treeContext,
                as = rC(p.nextSibling),
                ai = s,
                ac = !0,
                af = null,
            ...
            if (o) {
                ...
                a.pendingProps = y,
                t.deletions = null) : (a = uQ(l, y)).subtreeFlags = 0xe00000 & l.subtreeFlags,
        ...
        function oA(e, t, n) {
            ...
            case 6:
                ...
                null !== oB && (oV ? (e = oB,
                n = n.stateNode,
                8 === e.nodeType ? e.parentNode.removeChild(n) : e.removeChild(n)) : oB.removeChild(n.stateNode));
                break;
            case 18:
                null !== oB && (oV ? (e = oB,
                n = n.stateNode,
                8 === e.nodeType ? rE(e.parentNode, n) : 1 === e.nodeType && rE(e, n),
                tz(e)) : rE(oB, n.stateNode));
                break;
            case 4:
                r = oB,
                a = oV,
                oB = n.stateNode.containerInfo,
                oV = !0,
                oj(e, t, n),
                oB = r,
                oV = a;
        ...
        function uv(e) {
            ...
            ug) : 0 !== (e = ts) ? e : e = void 0 === (e = window.event) ? 16 : tB(e.type)
        }
        function ub(e, t, n, r) {
            if (50 < up)
                throw up = 0,
                ...
                if (6 === t)
                    ...
                    case 3:
                        ...
                        (0x7c00000 & r) === r && 10 < (t = ua + 500 - eZ())) {
                            ...
                            e.timeoutHandle = rb(uO.bind(null, e, ur, uo), t);
                            break
                        }
                        uO(e, ur, uo);
                        break;
                    case 4:
                        ...
                        10 < (r = (120 > (r = eZ() - r) ? 120 : 480 > r ? 480 : 1080 > r ? 1080 : 1920 > r ? 1920 : 3e3 > r ? 3e3 : 4320 > r ? 4320 : 1960 * oG(r / 1960)) - r)) {
                            e.timeoutHandle = rb(uO.bind(null, e, ur, uo), r);
                            break
                        }
                        uO(e, ur, uo);
                        break;
                ...
                0 == (32768 & t.flags)) {
                    if (null !== (n = function(e, t, n) {
                            ...
                            null === (c = s.rendering))
                                ...
                                if (!r)
                                    if (null !== (e = a8(c))) {
                                        ...
                                        2 * eZ() - s.renderingStartTime > ul && 0x40000000 !== n && (t.flags |= 128,
                                        r = !0,
                                        o_(s, !1),
                                        t.lanes = 4194304);
                        ...
                        case 23:
                            ...
                            r && 0 != (1 & t.mode) ? 0 != (0x40000000 & o6) && (oT(t),
        ...
        function uB(e, t, n) {
            ...
            o2 === e && (o4 & n) === n && (4 === o5 || 3 === o5 && (0x7c00000 & o4) === o4 && 500 > eZ() - ua ? uR(e, 0) : ut |= n),
            uk(e, t)
        }
        function uV(e, t) {
            0 === t && (0 == (1 & e.mode) ? t = 1 : (t = tt,
            0 == (0x7c00000 & (tt <<= 1)) && (tt = 4194304)));
            var n = uy();
            null !== (e = aB(e, t)) && (tu(e, t, n),
            uk(e, n))
        }
        function uj(e) {
            var t = e.memoizedState
        ...
        function uK(e, t, n, r, a, l) {
            ...
            "function" == typeof e)
                ...
                case N:
                    ...
                    break;
                case F:
                    return (e = uW(12, n, t, 2 | a)).elementType = F,
                    e.lanes = l,
                    e;
                case I:
                    ...
                    e;
                case O:
                    return (e = uW(19, n, t, a)).elementType = O,
                    e.lanes = l,
                    e;
                case U:
                    return uX(n, a, l, t);
                    ...
                    if (0 == (e.lanes & n) && 0 == (128 & t.flags))
                        ...
                        function(e, t, n) {
                            ...
                            case 10:
                                ...
                                rj(aP, r._currentValue),
                                r._currentValue = a;
                                break;
                            case 13:
                                if (null !== (r = t.memoizedState)) {
                                    if (null !== r.dehydrated)
                                        return rj(a6, 1 & a6.current),
                                        t.flags |= 128,
                                        null;
        ...
        td = function(e) {
            if (13 === e.tag) {
                var t = aB(e, 0x8000000);
                null !== t && ub(t, e, 0x8000000, uy()),
                u8(e, 0x8000000)
            }
        }
        ,
    ...
    98731: (e, t) => {
        ...
        function x(e, n) {
            ...
            try {
                for (w(n),
                p = r(c); null !== p && (!(p.expirationTime > n) || e && !R()); ) {
                    var o = p.callback;
                    if ("function" == typeof o) {
                        p.callback = null,
                        h = p.priorityLevel;
    ...
    4477: (e, t) => {
                ...
                try {
                    e: {
                        ...
                        try {
                            t: {
                                for (S(e),
                                p = r(c); null !== p && !(p.expirationTime > e && P()); ) {
                                    var u = p.callback;
        ...
        t.unstable_scheduleCallback = function(e, a, l) {
            ...
            switch (l = "object" == typeof l && null !== l && "number" == typeof (l = l.delay) && 0 < l ? u + l : u,
            e) {
            case 1:
                var i = -1;
                break;
            ...
            l > u ? (e.sortIndex = l,
            n(f, e),
            null === r(c) && e === r(f) && (y ? (k(C),
            C = -1) : y = !0,
            z(x, l - u))) : (e.sortIndex = i,
            n(c, e),
            g || m || (g = !0,
            E || (E = !0,
            o()))),
...
//# sourceMappingURL=react-lib-2a6d7cb76994.js.map
